...
export default function ReportAppsPage({ onOpenApp }: { onOpenApp: (skillId: string) => void }) {
        ...
        <div className="h-full flex" style={{ backgroundColor: "#fafaf9" }}>
            ...
            <div className={`${previewApp ? "w-1/2" : "w-full"} flex flex-col overflow-hidden transition-all`}>
                <div className="flex items-center gap-3 px-6 py-3 border-b shrink-0" style={{ borderColor: t.accentBorder, backgroundColor: t.accentBg }}>
                    ...
                    <h2 className="text-sm font-bold" style={{ color: t.accentText }}>Report Apps</h2>
                ...
                <div className="flex-1 overflow-y-auto p-6">
                    ...
                    {!loading && apps.length === 0 && (
                        <div className="flex flex-col items-center justify-center h-64 gap-3">
                            ...
                            <p className="text-stone-400 text-sm">還沒有 Report App</p>
                            <p className="text-stone-400 text-xs">去 Report Lab 訓練一個吧！</p>
                        </div>
                    )}
                        ...
                        {apps.map(app => (
                            ...
                            >
                                <div className="flex items-start justify-between mb-2">
                                    ...
                                    <span className="text-[10px] px-2 py-0.5 rounded-full bg-green-100 text-green-700 font-semibold">Published</span>
                                </div>
            ...
            {previewApp && (
                <div className="w-1/2 flex flex-col border-l" style={{ borderColor: "#e7e5e4" }}>
                    ...
                    <iframe
                        src={`${API}/api/skill-app/${previewApp}`}
