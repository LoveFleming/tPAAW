# PAAW 公司同步清單（2026-08-20 ~ 08-23）

來源：tPAAW dev 分支 bff1ac6a（0.3.9）。下載路徑基底 = repo 根目錄。
範圍：08-20 00:00 之後的變更（8/20 當天 16 筆含在內，重複覆蓋無害）。
...
A  08-23  docs-paaw-sync-2026-08-13-23.md
...
## ② 修改檔案（96 個 — 下載覆蓋）
```
M  08-23  .paaw/cu-debug.log
M  08-23  package.json
M  08-23  packages/server/package.json
M  08-23  packages/server/src/context-engine.mjs
M  08-23  packages/server/src/lib/agent-exec-logger.mjs
M  08-23  packages/server/src/lib/agentic-binding.mjs
M  08-20  packages/server/src/lib/auto-dispatch-manager.mjs
M  08-20  packages/server/src/lib/auto-dispatch-shared.mjs
...
M  08-23  packages/server/src/lib/domain-agent-registry.mjs
M  08-20  packages/server/src/lib/feature-boundary.mjs
M  08-22  packages/server/src/lib/feature-map-validator.mjs
M  08-21  packages/server/src/lib/llm-utils.mjs
M  08-20  packages/server/src/lib/paaw-agent-loop.mjs
...
M  08-20  packages/server/src/lib/ru-resolver.mjs
...
M  08-23  packages/server/src/paaw-server.mjs
...
M  08-23  packages/server/src/routes/chat.mjs
M  08-21  packages/server/src/routes/coding-evidence.mjs
M  08-23  packages/server/src/routes/coding-features.mjs
M  08-20  packages/server/src/routes/coding-handover.mjs
M  08-23  packages/server/src/routes/coding-ops.mjs
M  08-23  packages/server/src/routes/coding-releases.mjs
M  08-21  packages/server/src/routes/coding-tasks.mjs
M  08-20  packages/server/src/routes/coding.mjs
...
M  08-21  packages/server/src/routes/release-unit.mjs
M  08-23  packages/server/src/routes/shared.mjs
M  08-23  packages/server/src/routes/skills-api.mjs
M  08-23  packages/server/src/routes/vibe-fs.mjs
...
M  08-23  packages/server/src/tools/index.mjs
M  08-23  packages/server/src/websocket/ws-handler.mjs
M  08-23  packages/ui/src/App.tsx
M  08-21  packages/ui/src/components/AgentConsole.tsx
M  08-22  packages/ui/src/components/AgentSideChat.tsx
M  08-23  packages/ui/src/components/ApiMapSidebar.tsx
M  08-20  packages/ui/src/components/AutoDispatchPanel.tsx
M  08-21  packages/ui/src/components/ChatMessages.tsx
M  08-23  packages/ui/src/components/CodeIntelPage.tsx
M  08-20  packages/ui/src/components/EMDashboard.tsx
M  08-21  packages/ui/src/components/EvidenceCard.tsx
M  08-20  packages/ui/src/components/FeatureMap.tsx
M  08-20  packages/ui/src/components/HandoverPanel.tsx
M  08-20  packages/ui/src/components/ModelSelector.tsx
M  08-23  packages/ui/src/components/ReleaseManagerPanel.tsx
...
M  08-23  packages/ui/src/components/TroubleshootingPanel.tsx
M  08-20  packages/ui/src/components/git/GitPanel.tsx
M  08-20  packages/ui/src/components/git/GitStatusView.tsx
M  08-20  packages/ui/src/i18n/locales/en.json
M  08-20  packages/ui/src/i18n/locales/ja.json
M  08-20  packages/ui/src/i18n/locales/zh-mix.json
M  08-20  packages/ui/src/i18n/locales/zh.json
M  08-23  packages/ui/src/pages/BackupSettings.tsx
M  08-21  packages/ui/src/pages/ChatView.tsx
M  08-20  packages/ui/src/pages/CodingIDE.tsx
...
## ③ 刪除檔案（1 個 — 公司機器要刪）
```
D  08-21  packages/ui/src/components/ReleaseUnitPanel.tsx
```

## ④ 可略過（runtime 掃描快取，會自動重建）
`.paaw/code-intelligence/*`（重掃即重建）、`.paaw/coding-memory/*`、`.paaw/changes/*`、`.paaw/cu-status.json`

## ⑤ .gitkeep 佔位（17 個 — 手動下載的話建空檔）
```
...
## ⚠️ 下載完記得
```bash
npm install   # 新依賴：tree-sitter-go（Go 支援）
```
