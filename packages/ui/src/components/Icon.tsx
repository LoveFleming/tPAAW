...
const PATHS: Record<string, { path: string; viewBox?: string; fill?: boolean; stroke?: boolean; color?: string }> = {
    ...
    lightning: { path: "M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z", fill: true },
    ...
    "nav-scroll":  { path: "M13.5 10.5V21M10.5 10.5V21M7.5 10.5V21M3.75 21h14.25a2.25 2.25 0 002.25-2.25V6.75a2.25 2.25 0 00-2.25-2.25h-1.372c-.516 0-1.006.178-1.395.5l-1.083.864a2.25 2.25 0 01-1.395.5H3.75a2.25 2.25 0 00-2.25 2.25v8.25a2.25 2.25 0 002.25 2.25z" },
    "nav-ruler":   { path: "M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15" },
    ...
    // Sidebar-enhanced icons
    wrench:    { path: "M21.75 6.75a4.5 4.5 0 01-4.884 4.484c-1.076-.091-2.264.071-2.95.904l-7.152 8.684a2.548 2.548 0 11-3.586-3.586l8.684-7.152c.833-.686.995-1.874.904-2.95a4.5 4.5 0 016.336-4.486l-3.276 3.276a3.004 3.004 0 002.25 2.25l3.276-3.276a4.5 4.5 0 01-1.606 3.846z" },
    terminal:  { path: "M6.75 7.5l3 2.25-3 2.25m4.5 0h3m-9 8.25h13.5A2.25 2.25 0 0021 18V6a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 6v12a2.25 2.25 0 002.25 2.25z" },
    sparkle:   { path: "M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.455 2.456L21.75 6l-1.036.259a3.375 3.375 0 00-2.455 2.456z" },
    puzzle:    { path: "M14.25 2.25c0 1.5-.75 3-2.25 3s-2.25-1.5-2.25-3H6.75a2.25 2.25 0 00-2.25 2.25v2.25c-1.5 0-3 .75-3 2.25s1.5 2.25 3 2.25v2.25a2.25 2.25 0 002.25 2.25h2.25c0-1.5.75-3 2.25-3s2.25 1.5 2.25 3h2.25a2.25 2.25 0 002.25-2.25V14.25c1.5 0 3-.75 3-2.25s-1.5-2.25-3-2.25V7.5a2.25 2.25 0 00-2.25-2.25h-2.25z" },
    presentation: { path: "M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m-9 0h9m-9 0l-1 3m10-3l-1 3m0 0H8.25" },
    "share-nodes": { path: "M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.18.324.283.696.283 1.093s-.103.77-.283 1.093m0-2.186l9.566-5.314m-9.566 7.5l9.566 5.314m0 0a2.25 2.25 0 103.935 2.186 2.25 2.25 0 00-3.935-2.186zm0-12.814a2.25 2.25 0 103.933-2.185 2.25 2.25 0 00-3.933 2.185z" },
    notebook:  { path: "M16.5 3.75V19.5a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 19.5V3.75m12 0H4.5m12 0V3a2.25 2.25 0 00-2.25-2.25H6.75A2.25 2.25 0 004.5 3v.75m12 0H18A2.25 2.25 0 0120.25 6v12A2.25 2.25 0 0118 20.25h-2.25M4.5 6.75h-1.5m1.5 3h-1.5m1.5 3h-1.5m1.5 3h-1.5m1.5 3h-1.5" },
