...
/**
 * Icon component — inline SVG icons for action buttons, theme switcher, and CLI badges.
 * File type icons use emoji via FileEmoji.tsx (unified across Mac/Windows/Linux).
 *
