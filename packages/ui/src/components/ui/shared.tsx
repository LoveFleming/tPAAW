    ...
    return (
        <div className="mt-1">
            <button
                ...
                className="flex w-full items-center px-4 py-2 text-sm font-bold uppercase tracking-wider text-stone-500 hover:text-stone-700 transition-colors"
            >
                <svg
...
export function NavItem({
    ...
    return (
        <button
            onClick={onClick}
            className={cn(
                "flex w-full items-center justify-between pr-4 py-1.5 text-left text-[13px] transition-colors",
            )}
            style={{
        ...
        >
            <div className="flex items-center gap-2.5 min-w-0">
                <span className="text-[13px] shrink-0" style={{ width: 16, textAlign: "center" }}>{emoji || "📄"}</span>
