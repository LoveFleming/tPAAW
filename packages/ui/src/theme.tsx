...
export const THEMES: Record<ThemeId, ThemePalette> = {
  ...
  "calm-exhaustion": {
    id: "calm-exhaustion", label: "舒緩疲憊", emoji: "☕",
    group: "舒緩杏仁核", desc: "暖奶茶色 — 溫潤安定，撫慰身心疲勞",
    ...
    accentBorder: "#FCD34D", accentText: "#78350F", accentHover: "#92400E",
    badgeString: "bg-amber-50 text-amber-700 border-amber-200",
    badgeNumber: "bg-yellow-50 text-yellow-700 border-yellow-200",
    badgeBoolean: "bg-orange-50 text-orange-600 border-orange-200",
    badgeNull: "bg-stone-100 text-stone-400 border-stone-200",
    badgeObject: "bg-rose-50 text-rose-600 border-rose-200",
    badgeArray: "bg-lime-50 text-lime-600 border-lime-200",
    syntaxString: "text-amber-700", syntaxNumber: "text-yellow-700",
    syntaxBoolean: "text-orange-600", syntaxKey: "text-stone-700",
  },
};
